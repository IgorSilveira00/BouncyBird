...
public class MainMenuView extends ScreenAdapter {
    ...
    public MainMenuView(MyBouncyBird game, boolean IS_ACTIVE) {
        ...
        if (!game.getBACKGROUND_MUSIC().isPlaying())
            game.getBACKGROUND_MUSIC().setVolume(game.getBACKGROUND_MUSIC().getVolume() / 4f);
    ...
    private void loadUI() {
        ...
        PLAY_BUTTON.setPosition(Gdx.graphics.getWidth() / 4f - PLAY_BUTTON.getWidth() / 1.4f,
        ...
        SETTINGS_BUTTON.setPosition(Gdx.graphics.getWidth() / 2f - SETTINGS_BUTTON.getWidth() / 2f,
                Gdx.graphics.getHeight() / 2f - SETTINGS_BUTTON.getHeight() / 2f);
    ...
    private void loadAssets() {
        ...
        this.game.getAssetManager().load( "resume_up.png" , Texture.class);
        this.game.getAssetManager().load( "resume_down.png" , Texture.class);
        this.game.getAssetManager().load( "restart_up.png" , Texture.class);
        this.game.getAssetManager().load( "restart_down.png" , Texture.class);
        this.game.getAssetManager().load( "faded_back.png" , Texture.class);
